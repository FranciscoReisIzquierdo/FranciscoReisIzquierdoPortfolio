...
export default function Introduction() {
  return (
    <section id="introduction" className="w-full min-h-screen flex items-center justify-center pt-14 sm:pt-16 md:pt-20 scroll-mt-14 sm:scroll-mt-16 md:scroll-mt-20">
        ...
        <div className="space-y-8 justify-self-start max-w-3xl lg:py-0 lg:pt-0">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-poppins font-semibold text-white leading-tight">
            ...
            <span className="font-mono text-blue-400 text-2xl sm:text-4xl md:text-5xl lg:text-3xl">
              ...
              <span className="typed-name">Francisco Izquierdo</span>
              <span className="brackets">{"}"}</span>
            </span>
          </h1>
          ...
          <div className="flex gap-4 mt-4">
            <a
              href="Francisco_Izquierdo_Resume.pdf"
              target="_blank"
