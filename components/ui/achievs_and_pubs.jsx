...
const AchievementsAndPublications = () => {
  const achievements = [
    ...
    },
    {
      ...
      description: "Colégio de Albergaria",
    },
    {
      content: {
      ...
      title: "Level 5 Saxophone",
      category: "Recognition",
      description: "Jobra Music Conservatory",
    },
  ];
  ...
  const publications = [
    {
      ...
      title: "Publication",
      category: "EPIA2024 International Conference on Artificial Intelligence",
      description: "Efficient Image Search and Retrieval System in Cloud Platforms",
      link: "https://link.springer.com/chapter/10.1007/978-3-031-73500-4_30",
    },
    {
      content: {
      ...
      title: "White Paper",
      category: "InnovAction Magazine",
      description: "Artificial Intelligence in Efficient Image Search on MEO Cloud",
      link: "https://www.alticelabs.com/shared-knowledge/whitepapers/white-paper-artificial-intelligence-in-efficient-image-search-on-meo-cloud/",
    },
  ];
  ...
  return (
    <section id="achievements_and_publications" className="w-full mx-auto py-8 lg:py-16 scroll-mt-[80px]">
      ...
      <div id="publications" className="mt-24 space-y-10">
        <h1 className="mt-24 mb-8 text-3xl sm:text-5xl lg:text-5xl font-semibold text-blue-200 font-poppins text-left">
